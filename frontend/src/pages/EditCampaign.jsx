    ...
    <div className="min-h-screen bg-gradient-to-r from-purple-100 to-blue-100 py-10 px-4">
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-2xl overflow-hidden">
        <div className="bg-gradient-to-r from-purple-700 to-blue-600 text-white p-8">
          ...
          <p className="mt-2">Update campaign details</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 p-8">
          ...
          <form onSubmit={handleUpdate}>
            ...
            <img
              src={previewImage || image || "https://via.placeholder.com/300"}
              alt="Preview"
          ...
          <div>
            ...
            <div className="bg-gray-50 rounded-xl shadow-md overflow-hidden">
              <img
                src={image || "https://images.unsplash.com/photo-1488521787991-ed7bbaae773c"}
                alt="Preview"
              ...
              <div className="p-4">
                ...
                <p className="text-gray-600 mt-2">{description || "Campaign description..."}</p>

                <p className="font-semibold mt-3">Goal: ₹{goalAmount || 0}</p>
              </div>
            </div>
          </div>
        </div>
